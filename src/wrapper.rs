...
pub struct ImGuiWrapper {
    ...
    // window_builder: Option<Box<dyn Fn(imgui::Ui)>>,
}
...
impl ImGuiWrapper {
    ...
    pub fn render<F>(&mut self, ctx: &mut Context,
                  hidpi_factor: f32,
                     window_builder: Option<Box<F>>)
    where for<'r> F: Fn(&'r imgui::Ui<'r>) {
        // Update mouse
        self.update_mouse();
        ...
        // let cl = self.window_builder.clone();
        ...
        // Various ui things
        {
            ...
            Window::new(im_str!("Hello world"))
                ...
                .build(&ui, || {
                    ...
                    // window_builder.as_ref().map(|b| (*b)(&ui));
                    window_builder.map(|b| (*b)(&ui));
